...
def calculate_tDCF_EER(cm_score, label, phase='eval'):
    truth_dir = '/home/zhongjiafeng/Model/N801/database/21LA-keys'
    ...
    min_tDCF, eer_cm = performance(cm_score, label, Pfa_asv, Pmiss_asv, Pfa_spoof_asv,cost_model)
    ...
    min_tDCF2, eer_cm2 = performance(cm_score, label, Pfa_asv, Pmiss_asv, Pfa_spoof_asv, cost_model, invert=True)
...
def performance(cm_score, label, Pfa_asv, Pmiss_asv, Pfa_spoof_asv,cost_model, invert=False):
